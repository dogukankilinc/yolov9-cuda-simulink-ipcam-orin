//
// File: MWCustomSliceLayer_Yolov9t0_ex_DLModel_2804.cu
//
...
void MWCustomSliceLayer_Yolov9t0_ex_DLModel_2804::createCustomLayer
...
MWCustomSliceLayer_Yolov9t0_ex_DLModel_2804::
  MWCustomSliceLayer_Yolov9t0_ex_DLModel_2804()
{
}

void MWCustomSliceLayer_Yolov9t0_ex_DLModel_2804::propagateSize()
{
  int32_T batchSize;
  batchSize = getInputTensor(0)->getBatchSize();
  resizeOutputTensor(15, 20, 64, batchSize, 1, 0);
  resizeOutputTensor(15, 20, 64, batchSize, 1, 1);
}

void MWCustomSliceLayer_Yolov9t0_ex_DLModel_2804::cleanupLayer()
{
}

void MWCustomSliceLayer_Yolov9t0_ex_DLModel_2804::predictEnqueueImpl(real32_T
  **inputs, real32_T **outputs)
{
  dlnetwork_layerPr_ky3w2k15cyr5m(inputs[0], outputs[0], outputs[1]);
}
