//
// File: MWSwishLayer_Yolov9t0_ex_DLModel_280170.cu
//
...
void MWSwishLayer_Yolov9t0_ex_DLModel_280170::createCustomLayer(MWTensorrtTarget::
...
MWSwishLayer_Yolov9t0_ex_DLModel_280170::MWSwishLayer_Yolov9t0_ex_DLModel_280170
  ()
{
}

void MWSwishLayer_Yolov9t0_ex_DLModel_280170::propagateSize()
{
  int32_T batchSize;
  batchSize = getInputTensor(0)->getBatchSize();
  resizeOutputTensor(60, 80, 80, batchSize, 1, 0);
}

void MWSwishLayer_Yolov9t0_ex_DLModel_280170::cleanupLayer()
{
}

void MWSwishLayer_Yolov9t0_ex_DLModel_280170::predictEnqueueImpl(real32_T
  **inputs, real32_T **outputs)
{
  dlnetwork_layerPredictWithCol_j(inputs[0], outputs[0]);
}
