...
#ifndef MW_TENSORRT_LAYER_IMPL_FACTORY
#define MW_TENSORRT_LAYER_IMPL_FACTORY
...
class MWTensorrtLayerImplFactory final : public MWLayerImplFactory {

  public:
    MWTensorrtLayerImplFactory() {
    }
    virtual ~MWTensorrtLayerImplFactory() {
    }
