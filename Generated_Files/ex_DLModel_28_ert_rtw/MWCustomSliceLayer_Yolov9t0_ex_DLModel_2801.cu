//
// File: MWCustomSliceLayer_Yolov9t0_ex_DLModel_2801.cu
//
...
void MWCustomSliceLayer_Yolov9t0_ex_DLModel_2801::createCustomLayer
...
MWCustomSliceLayer_Yolov9t0_ex_DLModel_2801::
  MWCustomSliceLayer_Yolov9t0_ex_DLModel_2801()
{
}

void MWCustomSliceLayer_Yolov9t0_ex_DLModel_2801::propagateSize()
{
  int32_T batchSize;
  batchSize = getInputTensor(0)->getBatchSize();
  resizeOutputTensor(120, 160, 16, batchSize, 1, 0);
  resizeOutputTensor(120, 160, 16, batchSize, 1, 1);
}

void MWCustomSliceLayer_Yolov9t0_ex_DLModel_2801::cleanupLayer()
{
}

void MWCustomSliceLayer_Yolov9t0_ex_DLModel_2801::predictEnqueueImpl(real32_T
  **inputs, real32_T **outputs)
{
  dlnetwork_layerPredictWithCo_ky(inputs[0], outputs[0], outputs[1]);
}
