//
// File: MWSwishLayer_Yolov9t0_ex_DLModel_280178.cu
//
...
void MWSwishLayer_Yolov9t0_ex_DLModel_280178::createCustomLayer(MWTensorrtTarget::
...
MWSwishLayer_Yolov9t0_ex_DLModel_280178::MWSwishLayer_Yolov9t0_ex_DLModel_280178
  ()
{
}

void MWSwishLayer_Yolov9t0_ex_DLModel_280178::propagateSize()
{
  int32_T batchSize;
  batchSize = getInputTensor(0)->getBatchSize();
  resizeOutputTensor(15, 20, 80, batchSize, 1, 0);
}

void MWSwishLayer_Yolov9t0_ex_DLModel_280178::cleanupLayer()
{
}

void MWSwishLayer_Yolov9t0_ex_DLModel_280178::predictEnqueueImpl(real32_T
  **inputs, real32_T **outputs)
{
  dlnetwork_layerPredictWithCol_m(inputs[0], outputs[0]);
}
