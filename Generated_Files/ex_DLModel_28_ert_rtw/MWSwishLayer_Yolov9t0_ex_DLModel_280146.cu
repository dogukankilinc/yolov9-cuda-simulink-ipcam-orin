//
// File: MWSwishLayer_Yolov9t0_ex_DLModel_280146.cu
//
...
void MWSwishLayer_Yolov9t0_ex_DLModel_280146::createCustomLayer(MWTensorrtTarget::
...
MWSwishLayer_Yolov9t0_ex_DLModel_280146::MWSwishLayer_Yolov9t0_ex_DLModel_280146
  ()
{
}

void MWSwishLayer_Yolov9t0_ex_DLModel_280146::propagateSize()
{
  int32_T batchSize;
  batchSize = getInputTensor(0)->getBatchSize();
  resizeOutputTensor(15, 20, 128, batchSize, 1, 0);
}

void MWSwishLayer_Yolov9t0_ex_DLModel_280146::cleanupLayer()
{
}

void MWSwishLayer_Yolov9t0_ex_DLModel_280146::predictEnqueueImpl(real32_T
  **inputs, real32_T **outputs)
{
  dlnetwork_layerPre_ky3w2k15cyr5(inputs[0], outputs[0]);
}
