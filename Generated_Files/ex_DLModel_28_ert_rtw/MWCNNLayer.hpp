...
class DLCODER_EXPORT_CLASS MWCNNLayer {
  ...
  public:
    ...
    static std::string getMwDlDataFilePath(const std::string& filePath);
    static std::string getCustomUserDataPath(const std::string& filePath);
  ...
  private:
    ...
    static std::string getFilePathFromEnvironmentVariable(const std::string& filePath, std::string ev);
