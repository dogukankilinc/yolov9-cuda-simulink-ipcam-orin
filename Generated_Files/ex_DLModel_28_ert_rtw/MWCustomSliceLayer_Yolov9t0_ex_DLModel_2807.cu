//
// File: MWCustomSliceLayer_Yolov9t0_ex_DLModel_2807.cu
//
...
void MWCustomSliceLayer_Yolov9t0_ex_DLModel_2807::createCustomLayer
...
MWCustomSliceLayer_Yolov9t0_ex_DLModel_2807::
  MWCustomSliceLayer_Yolov9t0_ex_DLModel_2807()
{
}

void MWCustomSliceLayer_Yolov9t0_ex_DLModel_2807::propagateSize()
{
  int32_T batchSize;
  batchSize = getInputTensor(0)->getBatchSize();
  resizeOutputTensor(30, 40, 48, batchSize, 1, 0);
  resizeOutputTensor(30, 40, 48, batchSize, 1, 1);
}

void MWCustomSliceLayer_Yolov9t0_ex_DLModel_2807::cleanupLayer()
{
}

void MWCustomSliceLayer_Yolov9t0_ex_DLModel_2807::predictEnqueueImpl(real32_T
  **inputs, real32_T **outputs)
{
  dlnetwork_layerPredic_ky3w2k15c(inputs[0], outputs[0], outputs[1]);
}
