//
// File: MWResize2DLayer_Yolov9t0_ex_DLModel_2801.cu
//
...
void MWResize2DLayer_Yolov9t0_ex_DLModel_2801::createCustomLayer
...
MWResize2DLayer_Yolov9t0_ex_DLModel_2801::
  MWResize2DLayer_Yolov9t0_ex_DLModel_2801()
{
}

void MWResize2DLayer_Yolov9t0_ex_DLModel_2801::propagateSize()
{
  int32_T batchSize;
  batchSize = getInputTensor(0)->getBatchSize();
  resizeOutputTensor(30, 40, 128, batchSize, 1, 0);
}

void MWResize2DLayer_Yolov9t0_ex_DLModel_2801::cleanupLayer()
{
}

void MWResize2DLayer_Yolov9t0_ex_DLModel_2801::predictEnqueueImpl(real32_T
  **inputs, real32_T **outputs)
{
  dlnetwork_layerPredictWithCol_f(inputs[0], outputs[0]);
}
