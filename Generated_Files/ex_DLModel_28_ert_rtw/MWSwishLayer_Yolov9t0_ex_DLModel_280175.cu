//
// File: MWSwishLayer_Yolov9t0_ex_DLModel_280175.cu
//
...
void MWSwishLayer_Yolov9t0_ex_DLModel_280175::createCustomLayer(MWTensorrtTarget::
...
MWSwishLayer_Yolov9t0_ex_DLModel_280175::MWSwishLayer_Yolov9t0_ex_DLModel_280175
  ()
{
}

void MWSwishLayer_Yolov9t0_ex_DLModel_280175::propagateSize()
{
  int32_T batchSize;
  batchSize = getInputTensor(0)->getBatchSize();
  resizeOutputTensor(30, 40, 80, batchSize, 1, 0);
}

void MWSwishLayer_Yolov9t0_ex_DLModel_280175::cleanupLayer()
{
}

void MWSwishLayer_Yolov9t0_ex_DLModel_280175::predictEnqueueImpl(real32_T
  **inputs, real32_T **outputs)
{
  dlnetwork_layerPredictWithCol_p(inputs[0], outputs[0]);
}
