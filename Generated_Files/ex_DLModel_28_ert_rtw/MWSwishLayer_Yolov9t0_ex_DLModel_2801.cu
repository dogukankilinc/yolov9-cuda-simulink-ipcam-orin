//
// File: MWSwishLayer_Yolov9t0_ex_DLModel_2801.cu
//
...
void MWSwishLayer_Yolov9t0_ex_DLModel_2801::createCustomLayer(MWTensorrtTarget::
...
MWSwishLayer_Yolov9t0_ex_DLModel_2801::MWSwishLayer_Yolov9t0_ex_DLModel_2801()
{
}

void MWSwishLayer_Yolov9t0_ex_DLModel_2801::propagateSize()
{
  int32_T batchSize;
  batchSize = getInputTensor(0)->getBatchSize();
  resizeOutputTensor(240, 320, 16, batchSize, 1, 0);
}

void MWSwishLayer_Yolov9t0_ex_DLModel_2801::cleanupLayer()
{
}

void MWSwishLayer_Yolov9t0_ex_DLModel_2801::predictEnqueueImpl(real32_T **inputs,
  real32_T **outputs)
{
  dlnetwork_layerPredictWithColMa(inputs[0], outputs[0]);
}
