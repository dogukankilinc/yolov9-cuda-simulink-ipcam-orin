//
// File: MWSwishLayer_Yolov9t0_ex_DLModel_2806.cu
//
...
void MWSwishLayer_Yolov9t0_ex_DLModel_2806::createCustomLayer(MWTensorrtTarget::
...
MWSwishLayer_Yolov9t0_ex_DLModel_2806::MWSwishLayer_Yolov9t0_ex_DLModel_2806()
{
}

void MWSwishLayer_Yolov9t0_ex_DLModel_2806::propagateSize()
{
  int32_T batchSize;
  batchSize = getInputTensor(0)->getBatchSize();
  resizeOutputTensor(120, 160, 32, batchSize, 1, 0);
}

void MWSwishLayer_Yolov9t0_ex_DLModel_2806::cleanupLayer()
{
}

void MWSwishLayer_Yolov9t0_ex_DLModel_2806::predictEnqueueImpl(real32_T **inputs,
  real32_T **outputs)
{
  dlnetwork_layerPredictWithCol_k(inputs[0], outputs[0]);
}
