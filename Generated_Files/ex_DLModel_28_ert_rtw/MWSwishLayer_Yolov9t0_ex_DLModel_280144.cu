//
// File: MWSwishLayer_Yolov9t0_ex_DLModel_280144.cu
//
...
void MWSwishLayer_Yolov9t0_ex_DLModel_280144::createCustomLayer(MWTensorrtTarget::
...
MWSwishLayer_Yolov9t0_ex_DLModel_280144::MWSwishLayer_Yolov9t0_ex_DLModel_280144
  ()
{
}

void MWSwishLayer_Yolov9t0_ex_DLModel_280144::propagateSize()
{
  int32_T batchSize;
  batchSize = getInputTensor(0)->getBatchSize();
  resizeOutputTensor(30, 40, 96, batchSize, 1, 0);
}

void MWSwishLayer_Yolov9t0_ex_DLModel_280144::cleanupLayer()
{
}

void MWSwishLayer_Yolov9t0_ex_DLModel_280144::predictEnqueueImpl(real32_T
  **inputs, real32_T **outputs)
{
  dlnetwork_layerPredict_ky3w2k15(inputs[0], outputs[0]);
}
